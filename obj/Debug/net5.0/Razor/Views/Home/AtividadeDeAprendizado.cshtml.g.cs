#pragma checksum "D:\dev\Views\Home\AtividadeDeAprendizado.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "8d492b7414a6697e75640fa1fefb3ab58b4449c4"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"8d492b7414a6697e75640fa1fefb3ab58b4449c4", @"/Views/Home/AtividadeDeAprendizado.cshtml")]
    ...
    #nullable disable
    {
        ...
        {
            WriteLiteral("\r\n\r\n<html>\r\n  ");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("head", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "8d492b7414a6697e75640fa1fefb3ab58b4449c43221", async() => {
            ...
            WriteLiteral("\r\n  ");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("body", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "8d492b7414a6697e75640fa1fefb3ab58b4449c44417", async() => {
                WriteLiteral("\r\n    <header>\r\n        <h1>Oi Bill</h1>\r\n\r\n    </header>\r\n    <main>\r\n");
        ...
        <section class=""controles"">
          <fieldset>
            <div class=""conjunto-controles"">
                <button onclick=""sendxy()"">Enviar Posição X Y</button>
            </div>

            <div class=""conjunto-controles"">
              <label>x: <input type=""number"" value=""300"" id=""x-da-marcacao""></label>
              <label>y: <input type=""number"" value=""50"" id=""y-da-ma");
                WriteLiteral(@"rcacao""></label>
            ...
            <div class=""conjunto-controles"">
              <div class=""rotulos-proximos"">
                ...
                <label>
                  <input type=""radio"" name=""formato-da-ma");
                WriteLiteral("rcacao\" value=\"formato-oval\">oval\r\n                </label>\r\n              </div>\r\n            </div>\r\n          </fieldset>\r\n        </section>\r\n      </div>\r\n    </main>\r\n  ");
            }
            );
...
.foto-anotada img {
  box-");
            WriteLiteral(@"shadow: 0px 4px 4px rgba(0,0,0,.2);
...
cordotexto.addEventList");
            WriteLiteral(@"ener('change', changecordotexto);
...
function sendxy(event){
        ...
        xs = document.getElementById(""x-da-marcacao"").value;
        ys = document.getElementById(""y-da-marcacao"").value;
        ...
        $.ajax({
        url: ""https://localhost:44360/api/Position/SendPosition"",
        type: ""POST"",
        ...
        error: function (xhr, te");
            WriteLiteral(@"xtStatus, c) {
            if (xhr.status == 401) { 
                alert(""Session Expired!""); window.location = ""/Account""; 
            }
            else {
                debugger;
...
function selected(event) {
    ...
    formatocheked[1].checked = marcacaoselecionada.classList.contains('formato-oval') ? tru");
